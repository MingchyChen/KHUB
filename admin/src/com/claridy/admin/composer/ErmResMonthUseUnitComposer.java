...
public class ErmResMonthUseUnitComposer extends SelectorComposer {
	...
	public void confirm() throws InterruptedException {
		try {
			...
			if (count > 0) {
				...
				// WebEmployee loginwebEmployee=(WebEmployee)
				// ZkUtils.getSessionAttribute("webEmployee");
				...
				Listbox unitsLbx = (Listbox) ermResMonthUseUnitWin.getParent()
						.getFellowIfAny("unitsLbx");
				unitsLbx.setVisible(true);
				unitsLbx.setModel(WebOrgName);
				ermResMonthUseUnitWin.detach();
			} else {
				ZkUtils.showExclamation(Labels.getLabel("select"),
