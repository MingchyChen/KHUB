...
public class ErmResMonthUseDBComposer extends SelectorComposer {
...
//				WebEmployee loginwebEmployee=(WebEmployee) ZkUtils.getSessionAttribute("webEmployee");
				...
				Listbox dataBasesLbx =(Listbox)ermResMonthUseDBWin.getParent().getFellowIfAny("dataBasesLbx");
				dataBasesLbx.setVisible(true);
				dataBasesLbx.setModel(WebOrgName);
				ermResMonthUseDBWin.detach();
			} else {
