 ...
 *
 */
public class Resources_rsbatch_report {

	private int columnWidth=100;//colums的寬度
	...
	//有參構造函數
	public Resources_rsbatch_report(String headTextContent){
		headName=headTextContent; 
	}
	
	public JasperReport getJasperReport(String[] titleName,String[] titleValue) throws JRException{
		//創建一個報表設計圖的實例
